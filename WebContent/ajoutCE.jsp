...
<title>Ajouter un compte épargne</title>
...
<body class="comptee">
	...
	<h1>Ajouter un compte épargne</h1>

	<img class="im1" alt="" src="./assets/images/saving.png">

	<form class="form-horizontal" action="ajoutce" method="get">
		<div class="form-group">
			<label for="idNumeroCompte" class="col-sm-4 control-label">Numéro
				de compte : </label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<label for="idTaux" class="col-sm-4 control-label">Taux : </label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="idTaux"
					placeholder="taux" name="pTaux">
			</div>
		</div>
	...
	<form class="form-horizontal" action="attrce" method="post">
		<div class="form-group">
			<label for="idIdClient" class="col-sm-4 control-label">Id du
				client : </label>
