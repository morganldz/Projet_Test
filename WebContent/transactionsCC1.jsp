...
<body class="compte">
	...
	<form class="form-horizontal" action="retcc" method="post">
	...
	<form class="form-horizontal" action="depcc" method="post">
		<div class="form-group">
			<label for="idIdCompte" class="col-sm-4 control-label">Id du
				compte : </label>
			<div class="col-sm-4">
	...
	<form class="form-horizontal" action="transcc" method="post">
		<div class="form-group">
